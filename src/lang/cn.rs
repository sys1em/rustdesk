...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "你的电脑"),
        ("desk_tip", "你的电脑可以通过下面的 ID 和密码访问。"),
        ("Password", "密码"),
        ("Ready", "就绪，请联系鸿伍售后进行远程..."),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 鸿伍科技 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动服务"),
        ("Service is running", "服务正在运行"),
        ("Service is not running", "服务未运行"),
        ("not_ready_status", "未就绪，请检查网络连接，或者联系鸿伍售后..."),
        ("Control Remote Desktop", "控制远程电脑"),
        ("Transfer file", "传输文件"),
        ("Connect", "连接"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 鸿伍售后远控 安装到系统，从而规避上述问题。"),
        ...
        ("id_input_tip", "可以输入 ID、直连 IP...\n此功能仅供鸿伍科技相关人员使用，其它非鸿伍科技人员无法发起远程控制！"),
        ...
        ("Connection failed, please login!", "禁止远程，如您是鸿伍科技人员，请先登录！"),
    ].iter().cloned().collect();
}
